...
func Quota(v uint32) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func QuotaEQ(v uint32) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldQuota), v))
	})
}
...
func QuotaNEQ(v uint32) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func QuotaIn(vs ...uint32) predicate.Category {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func QuotaNotIn(vs ...uint32) predicate.Category {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func QuotaGT(v uint32) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func QuotaGTE(v uint32) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func QuotaLT(v uint32) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func QuotaLTE(v uint32) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func HasExpenses() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(ExpensesTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, ExpensesTable, ExpensesPrimaryKey...),
		)
...
func HasAccount() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAccountWith(preds ...predicate.Account) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
